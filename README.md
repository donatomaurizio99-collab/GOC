...
Nightly drift/warning workflows now upsert deduplicated GitHub issues (labels: `ci-drift` + signal label), reset recovery streak on active alerts, and auto-close recovered issues after 2 healthy nightly runs (configurable threshold).
