    ...
    *,
    ...
    if manifest_file.exists():
        ...
        for required_entry in required_manifest_entries:
            ...
            if manifest_entry is None:
                entry_path = _resolve_required_entry_path(project_root, manifest_file, required_entry)
                if _is_generated_after_manifest(
                    ...
                    entries_generated_after_manifest.append(required_entry)
                    continue
    ...
    report = {
        ...
        "metrics": {
            ...
            "evidence_attestation_generated_after_manifest_entries": len(entries_generated_after_manifest),
