param(
    ...
    [string]$OutputFile = "artifacts\\release-gate-operations-handoff-readiness-release-gate.json",
...
if ($LASTEXITCODE -ne 0) {
    throw "Release-gate operations handoff readiness check failed with exit code $LASTEXITCODE."
}

Write-Host "Release-gate operations handoff readiness check passed." -ForegroundColor Green
